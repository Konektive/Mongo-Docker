...
This project was made using Docker and Docker Compose, to run both api and the app, put both folders and the docker-compose file
in one main folder and run "docker-compose up" in the destination folder, after that you can go to "http://localhost:3000/" to see the App running. 
